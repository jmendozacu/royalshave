 ...
 *
 */
class Meigee_ThemeOptionsBizarre_Helper_Activation extends Mage_Core_Helper_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsBizarre/etc/blocks.xml';
