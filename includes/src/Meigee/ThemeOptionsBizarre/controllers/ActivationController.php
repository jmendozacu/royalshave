 ...
 *
 */
class Meigee_ThemeOptionsBizarre_ActivationController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
     $this->loadLayout(array('default'));
		...
		$this->_addContent($this->getLayout()->createBlock('themeoptionsbizarre/adminhtml_activation_edit'));
    ...
    public function saveAction() {
        ...
        try {
            ...
            foreach ($stores as $store) {
                ...
                Mage::getConfig()->saveConfig('design/package/name', 'bizarre', $scope, $store);
            ...
            if ($setup_pages) {
                Mage::getModel('ThemeOptionsBizarre/activation')->setupPages();
            }

            if ($setup_blocks) {
                Mage::getModel('ThemeOptionsBizarre/activation')->setupBlocks();
            }

            Mage::getSingleton('adminhtml/session')->addNotice(Mage::helper('ThemeOptionsBizarre')->__('<div class="meigee-please"><a target="_blank" href="https://meigeeteam.freshdesk.com/support/home"><img src="' . Mage::getBaseUrl('skin') . '/adminhtml/default/bizarre/images/support.png" /></a>&nbsp;<a target="_blank" href="http://themeforest.net/downloads"><img src="' . Mage::getBaseUrl('skin') . '/adminhtml/default/bizarre/images/rating.png" /></a><h2>Like us</h2>
<div id="fb-root"></div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
            ...
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('ThemeOptionsBizarre')->__('An error occurred while activating theme. '.$e->getMessage()));
        }
