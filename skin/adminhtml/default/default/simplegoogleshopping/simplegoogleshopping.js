...
var datafeedmanager = {
    ...
    checkSyntax: function () {
        ...
        datafeedmanager.CodeMirror = CodeMirror(
                function (elt) {
    ...
    enligthSyntax: function () {
        ...
        datafeedmanager.timer = setTimeout(
                function () {
                    $$('.cm-dfm').each(
                            function (cm) {
                        ...
                        m.observe(
                                'keydown', function (e) {
                                    ...
                                    switch (e.keyCode) {
                                        ...
                                        case 35:
                                            mapper = e.findElement('.mapping');
                                            mapper.up().up().select('ul').each(
                                                    function (u) {
                                                        u.addClassName('open')
                                                    }
                                            )
                                            mapper.up().up().select('input[type=text]').each(
                                                    function (i) {
                                                        i.focus();
