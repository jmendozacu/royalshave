 ...
 *
 */
class Meigee_ThemeOptionsBizarre_Model_Activation extends Mage_Core_Model_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsBizarre/etc/import/cms.xml';
