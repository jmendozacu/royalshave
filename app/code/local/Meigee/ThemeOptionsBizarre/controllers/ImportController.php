 ...
 *
 */
class Meigee_ThemeOptionsBizarre_ImportController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
     $this->loadLayout(array('default'));
		...
		$this->_addContent($this->getLayout()->createBlock('themeoptionsbizarre/adminhtml_import_edit'));
...
After static content importing you have to configure your store with new content. More detailed about configuration of predefined subthemes please read in the section "Predefined subthemes" of theme documentation.');
    ...
    public function saveAction() {
        ...
        try {
                ...
                Mage::getModel('ThemeOptionsBizarre/import')->getCorrectSet($static_block);

            Mage::getSingleton('adminhtml/session')->addNotice(Mage::helper('ThemeOptionsBizarre')->__('<div class="meigee-please"><a target="_blank" href="http://themeforest.net/downloads"><img src="' . Mage::getBaseUrl('skin') . '/adminhtml/default/bizarre/images/rating.png" /></a><h2>Like us</h2>
<div id="fb-root"></div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
            ...
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('ThemeOptionsBizarre')->__('An error occurred while importing blocks. '.$e->getMessage()));
        }
