...
class Meigee_MeigeewidgetsBizarre_Block_Brandslider
...
implements Mage_Widget_Block_Interface
{
	...
	public function getSliderOptions () {
        ...
        if ($this->getData('template') == 'meigee/meigeewidgetsbizarre/manufacturers.phtml' and $this->getData('autoSlide') == 1) {
            $options =
            ', autoSlide: 1, '
