...
class Amasty_Xnotif_Block_Product_View_Type_Configurable extends Amasty_Xnotif_Block_Product_View_Type_Configurable_Pure
{
    protected function _afterToHtml($html)
    {
        ...
        if ('product.info.options.configurable' == $this->getNameInLayout() && 'true' != (string)Mage::getConfig()->getNode('modules/Amasty_Stockstatus/active')&& !Mage::app()->getRequest()->isAjax())
        {
